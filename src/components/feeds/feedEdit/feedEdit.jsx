...
const FeedEdit = ({ props }) => {
    ...
    if (props.selectedPost && props.isEditing) {
      setCurrentState((prevState) => {
        ...
        return {
          ...
          oldImageValue: props.selectedPost.imageUrl,
          formIsValid: true,
        };
      });
  ...
  const cancelEditPost = () => {
    ...
    setCurrentState((prevState) => {
      return {
        ...prevState,
        cancelRequest: !currentState.cancelRequest,
      };
    });
  };
        ...
        <div className="feed-edit-popup">
          <FormComponent props={{ onSubmit: acceptPostChangeHandler }}>
            {!props.isAuthenticated && (
              ...
              >
                <p className="creat-post-reminder__authentication">
            ...
            <div className="new-post__image-preview">
              ...
              {currentState.base64Image && (
                <ImagePreview
                  props={{ imageURL: currentState.base64Image }}
                  contain
                  left
                />
              )}
                  ...
                  buttonProperties: [
                    {
                      ...
                      buttonTitle: state.isEditing ? "Update" : "Post",
                      disabled:
                        !state.isAuthenticated || !currentState.formIsValid,
                      mode: "",
                      design: "raised",
                      buttonLink: null,
                      buttonFunction: acceptPostChangeHandler,
                    },
                    {
                      buttonType: "reset",
                      buttonTitle: "Cancel",
